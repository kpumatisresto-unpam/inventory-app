    ...
    <div className="space-y-4 animate-in fade-in duration-500">
      ...
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-0.5">
          {pendingCount > 0
            ? `${pendingCount} catatan menunggu approval`
            : 'Semua catatan sudah diproses'}
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-muted-foreground">
          ...
          <p className="font-medium">
            {statusFilter === 'PENDING' ? 'Tidak ada catatan pending' : 'Tidak ada catatan'}
          </p>
        </div>
      ) : (
              ...
              <CardContent className="p-4 flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground">
                    oleh {log.pencatat?.full_name || '—'} • {log.type === 'IN' ? 'Masuk' : 'Keluar'} • {log.quantity} unit
                  </p>
                  <p className="text-xs text-muted-foreground">
